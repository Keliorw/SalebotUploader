    ...
    context "when there is a denylist" do
      ...
      describe "deprecation" do
        ...
        it "shows up" do
          ...
          expect { subject }.to raise_error(SalebotUploader::IntegrityError)
        end
      end
      ...
      context "when the denylist is an array of values" do
        context "when the file extension matches a denylisted extension" do
          ...
          it "raises an integrity error" do
            expect { subject }.to raise_error(SalebotUploader::IntegrityError, 'You are not allowed to upload "jpg" files, prohibited types: jpg, gif, png')
          end
        end
    ...
    context "when there is a blacklist" do
      ...
      it "looks for extension_denylist first for I18n translation" do
        ...
        change_locale_and_store_translations(:nl, :errors => {
          ...
          expect { subject }.to raise_error(SalebotUploader::IntegrityError, 'Het is niet toegestaan om "jpg" bestanden te uploaden; verboden bestandstypes: jpg, gif, png')
        end
      end
    end
  end
