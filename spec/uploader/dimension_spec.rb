    ...
    describe "image width range" do
      ...
      context 'without a processing module' do
        ...
        it "raises an error" do
          expect { subject }.to raise_error('You need to include one of SalebotUploader::MiniMagick, SalebotUploader::RMagick, or SalebotUploader::Vips to perform image dimension validation')
        end
      end

      context 'with a processing module' do
        before { uploader_class.include(SalebotUploader::MiniMagick) }
        ...
        context "when the width is below the minimum" do
          ...
          it "raises an integrity error" do
            expect { subject }.to raise_error(SalebotUploader::IntegrityError, 'Image width should be greater than 641px')
          end
        end
        ...
        context "when the width is above the maximum" do
          ...
          it "raises an integrity error" do
            expect { subject }.to raise_error(SalebotUploader::IntegrityError, 'Image width should be less than 639px')
          end
        end
    ...
    describe "image height range" do
      ...
      context 'with a processing module' do
        ...
        context "when the height is below the minimum" do
          ...
          it "raises an integrity error" do
            expect { subject }.to raise_error(SalebotUploader::IntegrityError, 'Image height should be greater than 481px')
          end
        end
        ...
        context "when the height is above the maximum" do
          ...
          it "raises an integrity error" do
            expect { subject }.to raise_error(SalebotUploader::IntegrityError, 'Image height should be less than 479px')
          end
        end
