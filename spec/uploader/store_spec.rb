...
describe SalebotUploader::Uploader do
  ...
  describe '#store!' do
    before do
      ...
      allow(SalebotUploader).to receive(:generate_cache_id).and_return('1390890634-26112-1234-2122')
      ...
      allow(@storage).to receive(:delete_dir!).with("uploads/tmp/#{SalebotUploader.generate_cache_id}")
  ...
  describe "#deduplicate" do
    ...
    before do
      allow(SalebotUploader::SanitizedFile).to receive(:sanitize_regexp).and_return(/[^A-z0-9\.\(\)]/)
