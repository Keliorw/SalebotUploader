...
describe SalebotUploader::Mount do
  ...
  describe '.mount_uploader' do
    ...
    before do
      @class = Class.new
      @class.send(:extend, SalebotUploader::Mount)

      @uploader = Class.new(SalebotUploader::Uploader::Base)
    ...
    describe "expected behavior with subclassed uploaders" do
      before do
        @class = Class.new
        @class.send(:extend, SalebotUploader::Mount)
        @uploader1 = Class.new(SalebotUploader::Uploader::Base)
    ...
    describe '#image_cache=' do
      ...
      before do
        allow(@instance).to receive(:write_uploader)
        allow(@instance).to receive(:read_uploader).and_return(nil)
        SalebotUploader::SanitizedFile.new(file_path('test.jpg')).copy_to(public_path('uploads/tmp/1369894322-123-0123-1234/test.jpg'))
      end
    ...
    describe '#image_integrity_error' do
      ...
      describe "when an integrity check fails" do
        ...
        it "should be an error instance if file was cached" do
          ...
          expect(e).to be_an_instance_of(SalebotUploader::IntegrityError)
    ...
    describe '#image_processing_error' do
      ...
      describe "when an processing error occurs" do
        ...
        it "should be an error instance if file was cached" do
          @instance.image = stub_file('test.jpg')
          expect(@instance.image_processing_error).to be_an_instance_of(SalebotUploader::ProcessingError)
        end
    ...
    describe '#image_download_error' do
      ...
      it "should be an error instance if file could not be found" do
        ...
        expect(@instance.image_download_error).to be_an_instance_of(SalebotUploader::DownloadError)
      end
    end
  ...
  describe '#mount_uploader without an uploader' do
    ...
    describe '#image' do
      ...
      it "should return an instance of a subclass of SalebotUploader::Uploader::Base" do
        expect(@instance.image).to be_a(SalebotUploader::Uploader::Base)
      end
  ...
  describe '#mount_uploader with a block' do
    ...
    describe 'and an uploader given' do
      ...
      it "should give the generated class a stable name" do
        expect(@instance.image.class).to eq @class.const_get :SalebotUploaderImageUploader
      end
    end
  end
  ...
  describe '#mount_uploader with :ignore_integrity_errors => false' do
    ...
    it "should raise an error if the image fails an integrity check when cached" do
      expect {
        @instance.image = stub_file('test.jpg')
      }.to raise_error(SalebotUploader::IntegrityError)
    end
  ...
  describe '#mount_uploader with :ignore_processing_errors => false' do
    ...
    it "should raise an error if the image fails to be processed when cached" do
      expect {
        @instance.image = stub_file('test.jpg')
      }.to raise_error(SalebotUploader::ProcessingError)
    end
  ...
  describe '#mount_uploader with :ignore_download_errors => false' do
    ...
    it "should raise an error if the image fails to be processed" do
      ...
      expect {
        @instance.remote_image_url = "http://www.example.com/test.jpg"
      }.to raise_error(SalebotUploader::DownloadError)
    end
