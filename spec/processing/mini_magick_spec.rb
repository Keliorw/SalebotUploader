...
describe SalebotUploader::MiniMagick do
  let(:klass) { Class.new(SalebotUploader::Uploader::Base) { include SalebotUploader::MiniMagick } }
  ...
  before do
    ...
    allow(instance).to receive(:file).and_return(SalebotUploader::SanitizedFile.new(landscape_copy_file_path))
  end
  ...
  describe "#convert" do
    ...
    it "respects the page parameter" do
      ...
      allow(instance).to receive(:file).and_return(SalebotUploader::SanitizedFile.new(tiff.path))
