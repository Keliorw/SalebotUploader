...
SalebotUploader.root = public_path
I18n.load_path << File.expand_path(File.join(File.dirname(__FILE__), '..', 'lib', 'salebot_uploader', 'locale', 'en.yml'))
...
RSpec.configure do |config|
  config.include SalebotUploader::Test::Matchers
  config.include SalebotUploader::Test::MockFiles
  config.include SalebotUploader::Test::MockStorage
  config.include SalebotUploader::Test::I18nHelpers
  config.include SalebotUploader::Test::ManipulationHelpers
  config.prepend SalebotUploader::Test::SsrfProtectionAwareWebMock
