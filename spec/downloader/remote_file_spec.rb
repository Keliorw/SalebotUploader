...
describe SalebotUploader::Downloader::RemoteFile do
  subject { SalebotUploader::Downloader::RemoteFile.new(file) }
  let(:file) do
...

  {
    ...
    context "with a #{response_class} instance" do
      ...
      it 'raises SalebotUploader::DownloadError' do
        expect { subject }.to raise_error(SalebotUploader::DownloadError, 'could not download file: No Content')
      end
    end
  end
