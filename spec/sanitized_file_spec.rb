...
describe SalebotUploader::SanitizedFile do
  before do
  ...
  describe '#empty?' do
    it 'should be empty for nil' do
      sanitized_file = SalebotUploader::SanitizedFile.new(nil)

      expect(sanitized_file).to be_empty
    end

    it 'should be empty for an empty string' do
      sanitized_file = SalebotUploader::SanitizedFile.new('')

      expect(sanitized_file).to be_empty
    end

    it 'should be empty for an empty StringIO' do
      sanitized_file = SalebotUploader::SanitizedFile.new(StringIO.new(''))
  ...
  describe '#original_filename' do
    it 'should default to the original_filename' do
      ...
      sanitized_file = SalebotUploader::SanitizedFile.new(file)
  ...
  describe '#basename' do
    it 'should return the basename for complicated extensions' do
      sanitized_file = SalebotUploader::SanitizedFile.new(file_path('complex.filename.tar.gz'))

      expect(sanitized_file.basename).to eq('complex.filename')
    end

    it 'should be the filename if the file has no extension' do
      sanitized_file = SalebotUploader::SanitizedFile.new(file_path('complex'))
  ...
  describe '#extension' do
    %w[gz bz2 z lz xz].each do |ext|
      it "should return the extension for complicated extensions (tar.#{ext})" do
        sanitized_file = SalebotUploader::SanitizedFile.new(file_path("complex.filename.tar.#{ext}"))
    ...
    it 'should return the extension for real-world user file names' do
      sanitized_file = SalebotUploader::SanitizedFile.new(file_path('Photo on 2009-12-01 at 11.12.jpg'))

      expect(sanitized_file.extension).to eq('jpg')
    end

    it 'should return the extension for basic filenames' do
      sanitized_file = SalebotUploader::SanitizedFile.new(file_path('something.png'))
  ...
  describe '#filename' do
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(nil) }
  ...
  describe '#content_type' do
    it "preserves file's content_type" do
      sanitized_file = SalebotUploader::SanitizedFile.new(content_type: 'image/png')

      expect(sanitized_file.content_type).to eq('image/png')
    end

    it "preserves file's content_type when passed as type (Rack)" do
      sanitized_file = SalebotUploader::SanitizedFile.new(type: 'image/png')
    ...
    it 'does not raise an error if missing' do
      sanitized_file = SalebotUploader::SanitizedFile.new('llama.jpg')
    ...
    it 'reads content type of a CSV linked to a file' do
      ...
      sanitized_file = SalebotUploader::SanitizedFile.new(csv_file)
    ...
    it 'does not allow spoofing of the mime type passed by Hash' do
      ...
      sanitized_file = SalebotUploader::SanitizedFile.new(tempfile: file, content_type: 'image/png')
  ...
  shared_examples_for 'all valid sanitized files' do
    ...
    describe '#move_to' do
      ...
      context 'target path only differs by case' do
        let(:upcased_sanitized_file) { SalebotUploader::SanitizedFile.new(stub_file('upcase.JPG', 'image/jpeg')) }
  ...
  describe 'with a valid Hash' do
    ...
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(hash) }
  ...
  describe 'with a valid Tempfile' do
    ...
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(tempfile) }
  ...
  describe 'with a valid StringIO' do
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(stub_stringio('llama.jpg', 'image/jpeg')) }
  ...
  describe 'with a valid File object' do
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(stub_file('llama.jpg', 'image/jpeg')) }
  ...
  describe 'with a valid path' do
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(file_path('llama.jpg')) }
  ...
  describe 'with a valid Pathname' do
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(Pathname.new(file_path('llama.jpg'))) }
  ...
  describe 'with an uploader instance' do
    ...
    let(:sanitized_file) { SalebotUploader::SanitizedFile.new(uploader) }
  ...
  describe 'that is empty' do
    let(:empty) { SalebotUploader::SanitizedFile.new(nil) }
  ...
  describe 'that is an empty string' do
    let(:empty) { SalebotUploader::SanitizedFile.new('') }
